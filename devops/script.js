...
const quizInfo = {
  gitlabAssociate: {
    ...
    desc: "GitLabの基本操作、プロジェクト、Issue、Merge Request、権限、リポジトリ管理"
  },
  gitlabCicdAssociate: {
    title: "GitLab Certified CI/CD Associate",
    desc: "GitLab CI/CD、.gitlab-ci.yml、Runner、Pipeline、Job、Artifact、Environmentの基礎"
  },
  jenkinsEngineer: {
    title: "Jenkins Engineer Certification",
    desc: "Jenkinsのジョブ、Pipeline、Agent、Plugin、Credential、ビルド運用、トラブルシューティング"
  }
};
...
if (type === "all") {
  document.title = "GitLab・Jenkins資格クイズ";
  pageTitle.textContent = "GitLab・Jenkins資格クイズ";
  pageDesc.textContent = "4カテゴリ・各180問から50問ランダムで出題";
} else {
  const info = quizInfo[type] || quizInfo.gitlabAssociate;
